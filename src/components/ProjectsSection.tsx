...
const projects = [
  {
    ...
    image: 'https://images.https://github.com/Riya-1702pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=400',
  ...
  {
    id: 5,
    title: 'Multi-Function Javascript Streamlit App',
  ...
  {id: 6,
    title: 'Multi-Function Python Streamlit App',
    description: 'Comprehensive web app with photo/video capture, messaging, and GPS location features',
    tags: ['#Streamlit', '#WebApp', '#Email', '#Media'],
    image: 'https://images.pexels.com/photos/1181298/pexels-photo-1181298.jpeg?auto=compress&cs=tinysrgb&w=400',
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            {projects.map((project, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-80 h-[480px] rounded-2xl overflow-hidden shadow-2xl border transition-all duration-300 ${
                    isActive 
